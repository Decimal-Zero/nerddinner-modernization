...
namespace NerdDinner.Proxy.Tests.TestSupport
{
    ...
    // dedicated LocalDB catalog ("NerdDinnerProxyTests", distinct from the
    ...
    public class ProxyTestDatabaseFixture : IDisposable
    {
        public const string ConnectionString =
            "Data Source=(LocalDB)\\MSSQLLocalDB;Initial Catalog=NerdDinnerProxyTests;Integrated Security=True;MultipleActiveResultSets=True";

        public ProxyTestDatabaseFixture()
        {
    ...
    [CollectionDefinition("NerdDinner.Proxy LocalDB collection")]
    public class ProxyDatabaseCollection : ICollectionFixture<ProxyTestDatabaseFixture>
    {
    }
}
